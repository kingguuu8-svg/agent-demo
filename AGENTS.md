...
Build a minimal, functionally complete runtime: every line must implement a requirement, protect correctness or security, enable testing, or clarify the design. Avoid speculative providers, databases, graphical UIs, generic plugin layers, and code-golf. Target 2,000-2,800 production lines and 1,000-1,600 test lines; these are review signals, not hard limits. Keep modules near 300 lines and functions near 50 lines. Exceed a guide when splitting would obscure the state machine.
